...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  const navItems = [
    { href: "/",         label: "Shoes",     icon: null,        badge: wardrobeCount },
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[#f8f9fa] flex justify-center lg:py-8 lg:px-4">
      ...
      <div className="w-full max-w-md md:max-w-2xl bg-background h-[100dvh] lg:min-h-[850px] lg:h-[850px] lg:border-[6px] lg:border-black lg:rounded-[3rem] lg:shadow-2xl relative overflow-hidden flex flex-col lg:overflow-y-auto">
                  ...
                  <Link href={item.href} className="flex flex-col items-center gap-1 group">
                    ...
                    >
                      {Icon ? (
                        ...
                        <span className="text-xl leading-none select-none" style={{ filter: "brightness(0)" }}>👠</span>
                      )}
